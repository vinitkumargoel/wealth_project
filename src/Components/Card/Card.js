...
class Card extends Component {
    ...
    render() {
        return (
            ...
            <img src={LBGicon} width="40px" height="40px" />
            ...
            <div><i ><FontAwesomeIcon icon={faPoundSign} className="pound-icon"/></i><span className="pound-icon">648.36</span></div>
            <div><span className="pound-icon">Available: </span><i ><FontAwesomeIcon icon={faPoundSign} className="pound-icon"/></i><span className="pound-icon">1023.76</span></div>
            </div>
